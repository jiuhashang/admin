...
export default {
  ...
  methods: {
    ...
    setData(data) {
      const {
        seProjectBuildElement, seProjectBuildElementCodeList, seProjectBuildCable, inverterType, seProjectBuildInverter, seProjectBuildInverterCodeList, seProjectBuildConnectionLand } = data
