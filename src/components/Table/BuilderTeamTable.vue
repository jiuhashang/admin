    ...
    <el-card>
      <div style="display:flex;justify-content:space-between;">
        <el-form ref="ruleForm" :model="tableInfo" inline>
          <el-form-item>
            <el-input v-model="tableInfo.query" placeholder="施工单位搜索" clearable style="width:300px;" />
          </el-form-item>
...
<script>
import { getBuilderTeamList } from '@/api/unitManage'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      const param = { ...resetTableInfo, ...this.queryInfo, companyName: query }
      getBuilderTeamList(param).then(res => {
        // console.log(res)
