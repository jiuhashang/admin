    ...
    <el-card>
      <div style="display:flex;justify-content:space-between;">
        <el-form ref="ruleForm" :model="tableInfo" inline>
          <el-form-item>
            <el-input v-model="tableInfo.query" placeholder="项目ID、项目公司搜索" clearable style="width:300px;" />
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      const param = { ...resetTableInfo, ...this.queryInfo, companyName: query, buildName: query, projectId: query }
